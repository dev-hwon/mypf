    ...
    <div id="header">
      <div className="my_info">
        ...
        <div className="tx_link tx_shortening_1">
          GIT :
          <Link to="https://github.com/dev-hwon/" target="_brank">
      ...
      <div className="my_theme">
        ...
        <ul>
          <li>
            <button onClick={themeClick} data-color="dark"></button>
          </li>
          <li>
            <button onClick={themeClick} data-color="white"></button>
          </li>
          <li>
            <button onClick={themeClick} data-color="blue"></button>
          </li>
        </ul>
      </div>
      <div className="my_copyright">thehyun1.design ⓒ All right reserved.</div>
    </div>
  );
}
